    ...
    <>
      <div
        ...
        <div className="mx-auto">
          <div className="heroDetailServices mx-4 max-w-[800px]">
            <h1 className="mx-auto md:ml-12 lg:ml-20 text-xl md:text-3xl text-[#fff] mb-6">
      ...
      <div className="col-span-12 mx-4 lg:mx-16 my-6">
        ...
        <div className="serviceItems">
          <div className="serviceItems-content mt-5">
            <h3 className="text-[#555555]">{selectedService?.ground?.title}</h3>
            <ul className="block mb-12">
